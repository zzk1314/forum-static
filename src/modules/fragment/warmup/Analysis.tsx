...
export default class Analysis extends React.Component <any, any> {
  ...
  render() {
    ...
    const discussRender = (discuss, idx) => {
      return (
        <DiscussShow key={idx} discuss={discuss} reply={()=>this.reply(discuss)} onDelete={this.onDelete.bind(this, discuss.id)}/>
      )
    }
    ...
    const choiceRender = (choice, idx) => {
      ...
      return (
        <div key={id} className={`hover-cursor choice${choice.selected ? ' selected' : ''}${choice.isRight ? ' right' : ''}`}>
