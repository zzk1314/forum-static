    ...
    render() {
        ...
        return (
            <Paper style={style.paper}>
                ...
                <div className="comment-count"><a href="/asst/commented" onMouseOut={this.onMouseOut.bind(this)} onMouseOver={this.onMouseOver.bind(this)}>
                    共点评过{' '}<div ref="total">{totalComment}</div>{' '}份</a></div>
            </Paper>
        )
    }
}
