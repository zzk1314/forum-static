  ...
  render () {
    ...
    return (
      <section style={{ padding: '25px 50px' }}>
        ...
        <TextField value={year} floatingLabelText="证书生成年份" onChange={(e, v) => this.setState({ year: v })}>
        </TextField><br/>

        <TextField value={month} floatingLabelText="证书生成月份" onChange={(e, v) => this.setState({ month: v })}>
        </TextField><br/>
        ...
        <SelectField value={identityType}
          ...
          <MenuItem value={this.identityType.EXCELLENT_COMMITTEE} primaryText="优秀班委"/>
        </SelectField><br/>
        ...
        <Dialog open={showDialog}>
          ...
          <div style={{ padding: '20px 50px' }}>
            ...
            <RaisedButton style={{ marginLeft: 30 }} label="确认" primary={true} onClick={() => this.handleMemberIds()}/>
          </div>
        </Dialog>

        <Snackbar open={showSnack} message="添加成功" autoHideDuration={3000} onRequestClose={() => {
