...
@connect(state => state)
export default class WarmProblemList extends React.Component<any,any> {
    ...
    return (
      <div className="problemContent">
        <div className="leftList" style={{position:'static'}}>
          <ProblemView chooseProblem={(problemId)=>this.chooseProblem(problemId)} problemList={problemList} comment={true}/>
        </div>
